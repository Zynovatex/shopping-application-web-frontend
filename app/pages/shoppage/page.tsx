...
export default function ProductListingPage() {
 ...
 const searchParams = useSearchParams();
  ...
  // Get shop parameters from URL query
  // const shopId = query.shopId as string;
  const shopName = decodeURIComponent((searchParams.get("shopName") as string) || "");
  ...
  const allTopSellingProducts = productsData.filter(
    (product) => product.isBestSeller
  );
  const allBestSellingProducts = productsData.filter(
  ...
  const remainingProducts = [
    ...productsData.filter((product) => !product.isBestSelling),
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="w-full bg-white shadow-lg rounded-lg p-6 flex flex-col lg:flex-row items-center text-center lg:text-left mr-12">
        ...
        <div className="flex-1 mr-48">
          ...
          <p className="text-gray-700 text-center mt-4 text-base">
            🛍️ Welcome to  {shopName} , your one-stop destination for
            high-quality products at the best prices. Explore our wide range of
            items, carefully selected to meet your needs!
          </p>
      ...
      <div className="container mx-auto py-6 flex flex-col lg:flex-row gap-x-10 mt-6">
        <aside
          className={`w-full mt-12 lg:w-[300px] xl:w-[350px] mr-3 ml-10 ${
      ...
      <div className="container mx-auto py-6 justify-start">
        ...
        <div className="text-gray-700 text-justify w-full mx-auto leading-relaxed px-36">
          <p>
            Welcome to <strong> {shopName} </strong>, your trusted store for
            quality products. We are dedicated to bringing you the best items
            with a focus on dependability, customer service, and uniqueness. Our
            store has been serving happy customers for years, and we strive to
            continue providing excellent products and services.  {shopName} 
            started with a simple vision – to offer a wide range of quality
            products that cater to the needs of our customers. Over the years,
            we have built a strong reputation for excellence, expanding our
            selection to include the latest trends, everyday essentials, and
            exclusive deals. With years of experience in the industry, we
            understand what our customers value the most – quality,
            affordability, and convenience. Our dedicated team works tirelessly
            to ensure that every product we offer meets the highest standards,
            giving you the confidence to shop with us. At  {shopName} , we believe
            in making shopping easy, enjoyable, and hassle-free. Our commitment
            to customer satisfaction drives us to provide reliable products,
            excellent service, and a shopping experience that keeps our
            customers coming back. Thank you for being a part of our journey. We
            look forward to serving you and continuing to grow together!
          </p>
        </div>
