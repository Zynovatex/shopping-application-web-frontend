...
const filterOptions = [
    { title: "Shops", options: ["Top Rated", "Ratings", "Authorized Seller", "Brand"] },
    ...
    { title: "Type", options: ["Supermart", "Local Grocery Store", "Organic Store", "Wholesale Market"] },
            ...
            <div className="max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 pr-2">
                {filterOptions.map((filter, index) => (
                    <div key={index} className="mb-3">
                        ...
                        {/* Section Options (Scrollable if many options) */}
